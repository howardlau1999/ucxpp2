...
local_memory_handle::local_memory_handle(context *ctx, ucp_mem_h mem)
    : ctx_(ctx), mem_(mem) {}
...
local_memory_handle
local_memory_handle::register_mem(context *ctx, void *address, size_t length) {
  ucp_mem_h mem;
...
local_memory_handle::allocate_mem(context *ctx, size_t length) {
  ucp_mem_h mem;
  ucp_mem_attr_t attr;
  ucp_mem_map_params_t map_params;
...
remote_memory_handle::remote_memory_handle(endpoint *endpoint,
...
endpoint *remote_memory_handle::endpoint_ptr() const { return endpoint_; }
