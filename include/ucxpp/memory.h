...
public:
   ...
   */
  local_memory_handle(context *ctx, ucp_mem_h mem);
   ...
   */
  static std::pair<void *, local_memory_handle> allocate_mem(context *ctx,
                                                             size_t length);
  static local_memory_handle register_mem(context *ctx, void *address,
                                          size_t length);
...
public:
   ...
   * peer
   */
  remote_memory_handle(endpoint *endpoint, void const *packed_rkey_buffer);
